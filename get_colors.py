...
def writetows(lists, ws, indexofsubcat, indexofpage):
    indexofimg = 1 + (72*indexofpage)
...
def start(start, end, subject, ws, indexofsubcat):
    ...
    for page in range(start, end+1):
        ...
        if pageValid:
            # 页面地址
            url = 'https://www.oilpaintings.com/colors/'+ subject + '/' + str(page)
            print '## 分类: ' + str(indexofsubcat) + ' - 页面: ' + str(page)
            ...
            for retryi in range(100):
                try:
                    ...
                    if int(currentpage) == page:
                        ...
                        writetows(lists, ws, indexofsubcat, indexofpage)
...
def bigstart():
    ...
    # 页面地址
    url = 'https://www.oilpaintings.com/colors'
    ...
    # 子分类列表
    subcats = soup.select('span.someclass')
    indexofsubcat = 0
    ...
    for subcat in subcats:
        catname = subcat.parent.get('href')
        ...
        start(1, 500, catname, ws, indexofsubcat)
        # print catname
